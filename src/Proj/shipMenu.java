...
public class shipMenu implements recur {
	...
	void pack_detail(String fromCoun,String toCoun) {
		...
		packBox.setModel(new DefaultComboBoxModel(new String[] {"Customer Supplied", "E-shipping Letter", "E-shipping Small", "E-shipping Medium","E-shipping Large"}));
		...
		serBox.setModel(new DefaultComboBoxModel(new String[] {"Select Transport","E-shipping saver pack", "E-shipping Express ", "E-shipping Express plus"}));
				...
				if(numPackField.getText().toString().isBlank()||wtField.getText().toString().isBlank()||transBox.getSelectedItem().toString().compareTo("Select Transport")==0||serBox.getSelectedItem().toString().compareTo("Select Service")==0){
					...
					{	
						...
						if(pack.compareTo("Customer Supplied")==0)
							packPrice=0;
						else if(pack.compareTo("E-shipping Letter")==0)
							packPrice=2;
						else if(pack.compareTo("E-shipping Small")==0)
							packPrice=4;
						else if(pack.compareTo("E-shipping Medium")==0)
							packPrice=6;
						else if(pack.compareTo("E-shipping Large")==0)
							packPrice=8;
						...
						if(ser.compareTo("E-shipping saver pack")==0)
							serPrice=10;
						else if(ser.compareTo("E-shipping Express ")==0)
							serPrice=20;
						else if(ser.compareTo("E-shipping Express plus")==0)
							serPrice=60;
